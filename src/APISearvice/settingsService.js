...
export const getSettingAPImanagemaster = async (_sp) => {
    let arr =[]
//    await _sp.web.lists.getByTitle("Settings").items.select("Title,ID,ImageIcon,LinkUrl, EnableAudienceTargeting,Audience/Title, Category").expand("Audience").filter("IsActive eq 'Yes' and Category eq 'Manage Master'").orderBy("Order", true)()
   await _sp.web.lists.getByTitle("Settings").items.select("Title,ID,ImageIcon,LinkUrl, EnableAudienceTargeting,Audience/Title, Category ,IsActive , Order").expand("Audience").filter("IsActive eq 'Yes' and Category eq 'Manage Master'").orderBy("Order", true)()
...
export const getSettingAPIPpowerappsmaster = async (_sp) => {
    let arr =[]
//    await _sp.web.lists.getByTitle("Settings").items.select("Title,ID,ImageIcon,LinkUrl, EnableAudienceTargeting,Audience/Title, Category").expand("Audience").filter("IsActive eq 'Yes' and Category eq 'Manage Master'").orderBy("Order", true)()
   await _sp.web.lists.getByTitle("Settings").items.select("Title,ID,ImageIcon,LinkUrl, EnableAudienceTargeting,Audience/Title, Category ,IsActive , Order").expand("Audience").filter("IsActive eq 'Yes' and Category eq 'Power Apps Master'").orderBy("Order", true)()
