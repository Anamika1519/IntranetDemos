              ...
              <div>
                ...
                <div className="heading-main">
                  ...
                  <div className="tile">
                    <ul>
                      <li>
                        ...
                        <a href="https://alrostamanigroupae.sharepoint.com/sites/IntranetUAT/SitePages/DMSMAIN.aspx">
                  ...
                  <div className="newbar">
                    ...
                    <p style={{ fontSize: '24px' }} className="text-muted">More Services are <span className="fw-bold text-dark">Coming Soon.</span></p>
